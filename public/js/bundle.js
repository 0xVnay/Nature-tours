...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoidmluYXlsZW9rdW1hciIsImEiOiJja2lpb21iYWoyNmp1MnFvNWc1Z2ZsN3NjIn0.zZwGHyWX_1424kzPP3r_Yw";
  var map = new mapboxgl.Map({
    container: "map",
    //mapbox will put the map on an element of id: map
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            console.log(res); // If user successfuly logged in
